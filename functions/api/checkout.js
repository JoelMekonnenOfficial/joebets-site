...
export async function onRequest({ request, env }) {
  ...
  const priceId = env.STRIPE_PRICE_ID_GOLD;
  const siteUrl = env.SITE_URL || env.URL || new URL(request.url).origin;
  ...
  params.append('success_url', `${siteUrl}/api/checkout-success?session_id={CHECKOUT_SESSION_ID}`);
